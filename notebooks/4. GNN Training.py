...
# MAGIC <div>
# MAGIC   <img src="https://github.com/alexxx-db/gnn-lvdr-pytorch/blob/main/images/ml-workflow.png?raw=True" alt="graph-training" width="840px", />
# MAGIC </div>
...
with mlflow.start_run(run_name="Patient Network GNN") as run:
