...
# MAGIC
# MAGIC tldr; You may skip to [implementation](https://e2-demo-west.cloud.databricks.com/?o=2556758628403379#notebook/3022585156459921/command/440341170534181) if the reader is familiar with GNN theory. This section focuses on _just enough_ theory to understand the implementation section.
# MAGIC
...
# MAGIC 2. [Hamilton, W. - Graph Representation Learning](https://www.cs.mcgill.ca/~wlh/grl_book/)
# MAGIC 3. [Scarselli et. al. - The Graph Neural Network Model](https://ieeexplore.ieee.org/document/4700287)
# MAGIC 4. [Teru et. al. - Inductive Relation Prediction by Subgraph Reasoning](https://arxiv.org/pdf/1911.06962.pdf)
